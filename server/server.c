...
{ 
    int sockfd=0, conx_acept=0, cont=0, l, t_struct; 
	...
	l = listen(s, NUM_CLIENTES) /* Ponemos el puerto a la escucha */
	...
	while(1)
	{
		conx_acept=accept(s, (struct sockaddr*)&servaddr, &t_struct);
		if(conx_acept>0)
		{ 			
